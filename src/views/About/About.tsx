        ...
        <div className="aboutBody">
          ...
          <Grid item  md={2} className="my-5 py-5"  >
             ...
             <Grid container item md={9} xs={12} className="my-1 py-5" justifyContent={"flex-start"} >
                ...
                <Grid item md={10} >
                  <svg width="100%" height="100%" className="chart-dot" style={{marginTop:"-8%", marginLeft:"4%"}} viewBox="0 0 1070 437" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Grid item xs={12} md={2}  >
                    <div className="about-cross">
                        <Typography letterSpacing={{xs: 2, sm:3,md:10}}>
                            PATH IN DETAIL
                        </Typography>
